...
### Port Renumbering (Server Removal)

**Breaking change**: Port assignments have been updated after removing redundant servers (slack, file-management, shell):

| Server | Old Port | New Port |
|--------|----------|----------|
| frontend-design | 8006 | 8005 |
| nano-banana | 8007 | 8006 |
| o3 | 8008 | 8007 |
| pdf | 8009 | 8008 |
| pptx | 8010 | 8009 |
| preview | 8011 | 8010 |
| vectorstore | 8014 | 8011 |
| xlsx | 8015 | 8012 |

If you have existing configurations referencing these ports, update them to use the new port numbers.
